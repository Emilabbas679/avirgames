    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="col-md-6 offset-md-3">
                <form class="user" method="POST" action="{{ route('category.update', $category->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    @if($category->img)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <img src="/uploads/category/{{$category->img}}" width="200" height="100" alt="">
                            </div>
                        </div>
