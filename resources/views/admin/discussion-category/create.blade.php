...
@section('title', 'Add Discussion Category')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="col-md-6 offset-md-3">
                <form class="user" method="POST" action="{{ route('discussion-category.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tab-content pt-2 pl-1" id="pills-tabContent">
                        ...
                        @endforeach
                            ...
                            <div class="form-group form-row">
                                <div class="col-md-3"><label for="question">Image</label></div>
                                <div class="col-md-9">
                            ...
                            <div class="form-group form-row">
                                <div class="col-md-3"><label for="question">Icon</label></div>
                                <div class="col-md-9">
                                    <input id="name" type="text" class="form-control @error('icon') is-invalid @enderror"
