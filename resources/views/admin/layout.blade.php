...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin">
            ...
            <div class="sidebar-brand-text mx-3">IGRA.AZ</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('discussion-category.index')}}">
                <i class="fab fa-facebook-messenger"></i>
                <span>Discussion Categories</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('discussion.index')}}">
                <i class="fab fa-facebook-messenger"></i>
                <span>Discussion</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('discussion-comment.index')}}">
                <i class="fab fa-facebook-messenger"></i>
                <span>Discussion comments</span></a>
        </li>
